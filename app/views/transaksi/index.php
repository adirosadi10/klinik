  ...
  <tbody>
    ...
    foreach ($data['transaksi'] as $transaksi) { ?>
      <tr>
        ...
        <td>
          <a class="tampilModalUbah" data-id="<?= $transaksi['id']; ?>" data-bs-toggle="modal" data-bs-target="#tambah<?= $transaksi['id']; ?>">Bayar</a> |
...
<?php foreach ($data['transaksi'] as $transaksi) { ?>
  ...
  <div class="modal fade" id="tambah<?= $transaksi['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalLabel">Pembayaran <?= $transaksi['no_transaksi'] ?></h5>
        ...
        <div class="modal-body">
          <form action="<?= BASE_URL; ?>/transaksi/update" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="number" value="<?= $transaksi['total'] ?>" readonly required class="form-control" id="total" name="total">
            </div>
            <div class="mb-3">
        ...
        <div class="modal-footer">
          ...
          <button id="submit" type="submit" onclick="valid();" class="btn btn-primary">Tambah</button>
          </form>
        </div>
      </div>
    </div>
...
<script src="<?= BASE_URL; ?>/js/transaksi.js" type="text/javascript"></script>
<script>
  function kurang() {
